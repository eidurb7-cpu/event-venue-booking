...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'home.why.curated.desc': 'Jeder Vendor wird vor Freigabe geprueft, damit du mit Vertrauen buchst statt zu raten.',
    'home.why.secure.title': 'Sichere Zahlungen',
    'home.why.secure.desc': 'Sicher bezahlen mit Stripe: transparente Summen, klare Gebuehren und serverseitig verifizierter Status.',
    'home.why.booking.title': 'Strukturierte Buchung',
    'home.why.booking.desc': 'Ein klarer Ablauf von Anfrage bis Zahlung, damit beide Seiten geschuetzt und organisiert bleiben.',
    ...
    'booking.summary.totalNotice': 'Der Gesamtpreis enthaelt interne Preisanpassungen und finale Service-Konditionen.',
  ...
  en: {
    ...
    'home.why.curated.desc': 'Every vendor is reviewed before approval so you book with confidence, not guesswork.',
    'home.why.secure.title': 'Secure Payments',
    'home.why.secure.desc': 'Pay securely with Stripe, with transparent totals and server-verified payment status.',
    'home.why.booking.title': 'Structured Booking',
    'home.why.booking.desc': 'A clean flow from request to confirmation to payment keeps both sides protected and organized.',
    ...
    'booking.summary.totalNotice': 'Total includes internal pricing adjustments and final service conditions.',
